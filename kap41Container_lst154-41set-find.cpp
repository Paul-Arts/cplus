    ...
    void suchmal(const set<int>&data, int was, ostream&os) {
        ...
        // [lo,up] ist nun das gleiche, was equal_range geliefert h?tte
        os << " Bereich:{";
        for( ; lo != up; ++ lo) {
          os << *lo << ' ';
        }
