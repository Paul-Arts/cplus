    ...
    int main() {
        vector<int> werte{ };
        werte.reserve(50);                      // Platz f?r 50 Werte garantieren
        ...
        //= 20 2 30 15 81 104 70 2
        // groesstes enth?lt nun die Adresse der 104:
        *groesstes = -999;                      // dereferenzieren; also Wert ?berschreiben
        printVector(cout, werte) << "\n";       // Ausgabe: 20 2 30 15 81 @MINUS@999 70 2
        //= 20 2 30 15 81 -999 70 2
    }
