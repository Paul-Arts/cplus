    ...
    struct Stadt { //#
     ...
     int main() { //#
         ...
         //= Bielefeld hat 0 Postleitzahlen.
         cout << "Die Postleitzahlen von Bielefeld sind:\n"; //#
         //= Die Postleitzahlen von Bielefeld sind:
         auto bereich = verzeichnis.equal_range(such); //#
         while(bereich.first != bereich.second) { //#
             cout << "  " << bereich.first->plz_ << '\n'; //#
             ++bereich.first; //#
         } //#
         cout << "Wie oft? " << verzeichnis.count(Eintrag{"Bielefeld",33615}) << "\n"; //#
         //= Wie oft? 1
     } //#
